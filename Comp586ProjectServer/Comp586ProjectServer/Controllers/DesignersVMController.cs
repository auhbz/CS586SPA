...
namespace Comp586ProjectServer.Controllers
{
    ...
    [ApiController]
    public class DesignersVMController : ControllerBase
    {
        private readonly spa586Context _context;

        public DesignersVMController(spa586Context context)
        {
            _context = context;
        }
        ...
        // GET: api/Designer
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DesignersViewModel>>> GetDesigners()
        {
            var designers_games = from designer in _context.Designers
                                  select new DesignersViewModel
                                  {
                                      Id = designer.Id,
                                      Name = designer.Name,                                     
                                  };
